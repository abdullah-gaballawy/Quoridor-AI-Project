...
![Main menu with Human vs AI selected](GAME_Q/screenshots/menu_ai_difficulty.png)
...
![Initial board](GAME_Q/screenshots/initial_board.png)
...
|---|---|
| ![Pawn movement hints](GAME_Q/screenshots/pawn_move_hints.png) | ![Wall preview](GAME_Q/screenshots/wall_preview.png) |
...
|---|---|
| ![Loaded game](GAME_Q/screenshots/game_loaded.png) | ![Game over](GAME_Q/screenshots/game_over.png) |
